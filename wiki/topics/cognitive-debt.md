...
Cognitive debt is the delayed cost to attention, learning, transfer, ownership, and mental health when AI-supported work chronically reduces active cognitive engagement. The useful boundary is temporal: output quality can remain acceptable while the worker practices less, remembers less, verifies less, and recovers less, so the cost appears later as weaker transfer, poorer recall, reduced judgment ownership, or burnout risk rather than as an immediate task failure.
...
## Connections
- Relates to [[ai-mediated-learning]] because learning transfer is one of the main places cognitive debt becomes measurable after the AI-supported episode ends.
- Relates to [[ai-induced-skill-erosion]] because cognitive debt is a plausible accumulation pathway into durable capability loss, but it should not be treated as proven long-term erosion without longitudinal evidence.
- Relates to [[cognitive-load-in-ai-assisted-work]] because cognitive debt depends on the difference between productive effort that builds comprehension and extraneous burden that consumes capacity without building skill.
- Relates to [[digital-work-strain]] because attentional erosion, affective depletion, recovery failure, and silent burnout are occupational-health outcomes, not just cognitive-performance variables.
- Relates to [[critical-thinking]] because verification and stewardship preserve epistemic contact with the work; when AI bypasses those operations, current output quality can hide future judgment loss.
- Relates to [[ai-supported-knowledge-synthesis]] because AI synthesis tools can help organize evidence while also weakening direct engagement with sources, uncertainty, and alternative interpretations.
