...
Job analysis is the upstream work-definition process behind many HR systems: selection, assessment, performance management, compensation, training, work design, and legal defensibility. It defines the tasks, KSAOs, work contexts, and performance domains that later measurement and decision systems treat as job relevant.

[[2022-strah-diversity-issues-job-analysis]] shows why job analysis should not be treated as automatically neutral just because it is systematic. If job-analysis data capture majority-group norms, biased archival language, unequal SME voice, or averaged ratings that erase subgroup differences, then downstream HR systems can inherit a narrow definition of successful performance. The foundation can be procedurally careful and still construct-deficient.
