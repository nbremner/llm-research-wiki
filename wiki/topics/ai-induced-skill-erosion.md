...
AI-induced skill erosion is the slow loss of practiced judgment, craft, confidence, or professional identity when AI absorbs enough of the work that humans stop exercising the capabilities the system still depends on. The construct is narrower than [[automation-complacency]]: complacency describes reduced attention or effort in the moment; skill erosion asks whether repeated reliance changes the worker's capability over time.
...
- Relates to [[cognitive-debt]] because debt names the accumulating liability between repeated AI bypass/offloading episodes and later durable capability loss.
