...
Behavioral human-centered AI is the design and deployment stance that treats AI adoption as a behavioral change problem, not only a technical, ethical, or interface-design problem. [[2025-schweitzer-leading-ai-adoption]] argues that human-centered AI is incomplete if it assumes rational users, designers, and leaders will simply accept better-performing systems; bounded rationality, trust, autonomy, identity threat, loss aversion, overconfidence, escalation of commitment, and vivid failure narratives all shape whether AI becomes usable, accepted, governed, and institutionalized.
...
- Relates to [[ai-readiness]] because readiness includes whether leaders and implementation teams can diagnose human reactions, run behaviorally informed change management, and avoid managerial overconfidence or escalation of commitment.
- Relates to [[responsible-ai-deployment]] because fairness, transparency, autonomy, and control do not become responsible practice unless the deployment design accounts for how real stakeholders understand, contest, and act on those features.
- Relates to [[human-ai-collaboration]] because collaboration quality depends on how people calibrate trust, effort, authority, and vigilance when AI makes mistakes, appears confident, or changes the human role.
...
- [[2025-schweitzer-leading-ai-adoption]] is a conceptual synthesis, so the stage model is useful but not yet a validated implementation model. The wiki needs field evidence on whether behaviorally informed AI change management improves adoption, trust calibration, worker outcomes, or system value.
