...
Employee engagement is a useful case for the wiki because it shows how quickly a practitioner-facing people construct can become operationally important before its nomological network, measurement model, and causal claims are clean.

[[2014-briner-employee-engagement-evidence-based]] argues that the popular HR concept of employee engagement suffers from five linked problems: no agreed definition, weak or overlapping measures, limited distinctiveness from older constructs, little public causal evidence on performance effects or interventions, and frequent over-claiming by advocates. The important move is not “engagement does not matter”; it is that the field often acts as if it knows what engagement is and what it causes before the construct and evidence base can bear that weight.

For AI workforce transformation, this matters as a warning. If organizations start measuring “AI engagement,” “AI readiness,” or “AI adoption mindset” with similarly loose construct boundaries, people analytics will reproduce the same problem under newer labels.
