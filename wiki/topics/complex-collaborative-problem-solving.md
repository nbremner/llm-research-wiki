---
title: Complex and collaborative problem solving
status: active
updated: 2026-06-24
---
...
Complex and collaborative problem solving names a pair of transversal skills for work where the problem structure is dynamic, information must be actively acquired, and useful performance depends on applying knowledge under uncertainty either alone or with others. [[2015-neubert-assessment-21st-century-skills]] argues that CPS and ColPS are especially useful for I-O psychology because they sit between broad latent attributes such as intelligence and narrower practice labels such as learning agility, talent, or leadership potential.

The assessment contribution is the important part for this wiki: CPS and ColPS can be operationalized through computer-based microworlds that vary problem features systematically, simulate active exploration and control, and collect process data about how people search, coordinate, and adapt. That makes them a candidate bridge between [[job-analysis]] and [[construct-validity]]: close enough to nonroutine and interactive work to matter, but theoretically specified enough to avoid becoming another loose competency label.

For AI workforce transformation, CPS and ColPS are a reminder that “future skills” claims need assessment designs that represent changing work demands rather than merely rename broad capability aspirations. As AI absorbs routine production and changes the human role toward diagnosis, coordination, exception handling, and verification, the useful question is not whether people have a generic future skill; it is whether the assessment captures the problem features, collaboration demands, information search, and adaptive control that the redesigned work actually requires.
