...
Seed questions to grow topics around. Edit freely.
...
- How should AI-mediated learning and cognitive-debt measures incorporate neurodivergence, sensory tolerance, pacing, recovery, and other individual differences without converting accommodation-sensitive signals into deficit labels?
...
- **Measurement of AI workforce impact** has been promoted into [[ai-workforce-impact-measurement]] through [[2025-tomlinson-working-with-ai]], [[2026-massenkoff-labor-market-impacts-ai]] adds observed-exposure evidence linking theoretical capability, Claude work-use traces, BLS projections, unemployment, and young-worker job starts, and [[2026-richmond-ai-jobs-transition-framework]] adds a transition-archetype frame combining exposure, human necessity, demand elasticity, and ChatGPT usage. The wiki still needs field evidence linking applicability, observed exposure, or transition archetypes to realized productivity, quality, job redesign, wages, staffing decisions, skill development, and worker experience.
...
- **AI-mediated learning and cognitive debt** has been promoted into [[ai-mediated-learning]] through [[2026-shen-ai-impacts-skill-formation]] and [[2025-kosmyna-brain-chatgpt-cognitive-debt]], and [[2026-guilbeault-simple-threshold]] now adds a non-AI boundary condition on human threshold learning versus LLM-style predictive optimization, but the wiki still needs workplace-longitudinal evidence on whether AI-supported learning designs preserve transfer, debugging skill, professional judgment, and expertise maintenance over time.
...
- **neurodivergent-ai-work-design / cognitive sustainability** — appears in [[2026-ruttenberg-neurodivergent-expertise-ai-work]] as an agenda-setting claim that autistic and neurodivergent professionals provide design expertise for detecting and preventing cognitive debt in AI-augmented knowledge work; promote if future empirical or participatory-design sources test AI workflows, learning transfer, sensory load, recovery, or burnout among neurodivergent workers.
