...
- **Measurement of AI workforce impact** has been promoted into [[ai-workforce-impact-measurement]] through [[2025-tomlinson-working-with-ai]], and [[2026-massenkoff-labor-market-impacts-ai]] now adds observed-exposure evidence linking theoretical capability, Claude work-use traces, BLS projections, unemployment, and young-worker job starts. The wiki still needs field evidence linking applicability or exposure scores to realized productivity, quality, job redesign, wages, staffing decisions, skill development, and worker experience.
