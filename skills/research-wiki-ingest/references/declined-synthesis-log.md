...
Entries are added by the local Claude from the owner's PR review comments, or by NicholasJunior when the owner rejects a paper in Discord (the ingest skill's "Owner rejection command"), never by the batch itself.
