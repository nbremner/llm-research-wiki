...
WIKI_CONCEPT_ENRICHMENT = {
    ...
    "ai-mediated-choice-and-identity": ["algorithmic recommendation", "personalization", "preference distinctiveness", "self-expression", "identity-relevant", "delegated choice"],
    "ai-mediated-knowledge-behavior": ["knowledge sharing", "knowledge hiding", "threat appraisal", "psychological empowerment"],
    ...
    "ai-workforce-transformation-implementation": ["workforce transformation", "ai implementation", "implementation sequence", "pilot program", "scaling ai"],
    "behavioral-human-centered-ai": ["human-centered ai", "bounded rationality", "behavioral science", "behavioral change", "user acceptance"],
    ...
    "cognitive-sustainability": ["cognitive sustainability", "human capability", "skill atrophy", "sustainable work"],
    "digital-work-strain": ["technostress", "digital strain", "information overload", "boundary invasion", "digital fatigue", "burnout", "occupational health"],
    "domain-expertise-in-agentic-work": ["domain expertise", "domain knowledge", "expert users", "verify agent", "steering ai"],
    "employee-change-support": ["change support", "championing", "change compliance", "resistance to change", "organizational change"],
    ...
    "human-ai-agent-interaction-design": ["interaction design", "agent interface", "oversight controls", "workflow interface", "usable control"],
    ...
    "organizational-learning-capability": ["organizational learning", "learning organization", "learning capability", "knowledge transfer", "absorptive capacity"],
}
